...
--Truncate and Insert transformed\cleaned data for bronze.crm_cust_info into silver layer
...
---Insert transformed\cleaned data for bronze.crm_prd_info into silver layer
start_time := clock_timestamp();
...
---Insert transformed\cleaned data for bronze.crm_sales_details into silver layer
start_time := clock_timestamp();
...
---Insert transformed\cleaned data for bronze.erp_cust_az12 into silver layer
start_time := clock_timestamp();
...
---bronze.erp_loc_a101
---Insert transformed\cleaned data for bronze.erp_loc_a101 into silver layer
 start_time := clock_timestamp();
...
---Insert transformed\cleaned data for bronze.erp_px_cat_g1v2 into silver layer
